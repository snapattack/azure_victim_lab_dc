...
# Copy Wallpaper
$wc.DownloadFile('https://raw.githubusercontent.com/snapattack/azure_victim_lab_dc/initial_modifications/Win10-AD/resources/APT1.jpg', 'C:\ProgramData\APT1.jpg')


# Copy BGInfo config
$wc.DownloadFile('https://raw.githubusercontent.com/snapattack/azure_victim_lab_dc/initial_modifications/Win10-AD/resources/dolabs.bgi', 'C:\ProgramData\dolabs.bgi')
